doUnloadModel:options:qos:error:: model=_ANEModel: { modelURL=file:///Users/ssz/Library/Developer/Xcode/DerivedData/FilmForensics-dfkezvwlkueossgdcqcpjwbsdkfu/Build/Products/Debug/MLmedia.app/Contents/Resources/yolofirstposattemp.mlmodelc/model0/ : sourceURL= (null) : key={"isegment":0,"inputs":{"image":{"shape":[640,640,1,3,1]}},"outputs":{"1172_1":{"shape":[80,8400,1,1,1]},"reduce_max_0":{"shape":[8400,1,1,1,1]},"1172_0":{"shape":[4,8400,1,1,1]}}} : identifierSource=0 : cacheURLIdentifier=EE7CD0DA9BC5098CD4020024EC6BC3653E9297DBD86DD765358B9821AC4AFE35_5B67014B4B3C17C93623F7C16A5C417D8E010A13C88820DAFD8052AF32B86BAA : string_id=0x00000000 : program=_ANEProgramForEvaluation: { programHandle=2951841336049 : intermediateBufferHandle=2951841945068 : queueDepth=127 } : state=3 : programHandle=2951841336049 : intermediateBufferHandle=2951841945068 : queueDepth=127 : attr={
  ...
  NetworkStatusList =     (
    {
      ...
      LiveOutputList =             (
        ...
        },
        {
          ...
          Height = 1;
          Interleave = 1;
          Name = "reduce_max_0@output";
          PlaneCount = 1;
          PlaneStride = 16832;
          RowStride = 16832;
          Symbol = "reduce_max_0@output";
          Type = Float16;
          Width = 8400;
        }
      );
